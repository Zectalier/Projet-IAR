...
class Actor(BasePolicy):
    ...
    def __init__(
        ...
        latent_pi_net = create_droQ_mlp(features_dim, -1, net_arch, activation_fn, dropout_rate=self.dropout_rate)
...
MlpPolicy = DroQPolicy


class CnnPolicy(DroQPolicy):
    """
    Policy class (with both actor and critic) for SAC.
...
class MultiInputPolicy(DroQPolicy):
    """
    Policy class (with both actor and critic) for SAC.
